...
MONGODB_ADMIN_PASS=${MONGODB_ADMIN_PASS:-"th34dmInPwd"}

# Set application user
MONGODB_APPLICATION_DATABASE=${MONGODB_APPLICATION_DATABASE:-"dba"}
MONGODB_APPLICATION_USER=${MONGODB_APPLICATION_USER:-"dba"}
MONGODB_APPLICATION_PASS=${MONGODB_APPLICATION_PASS:-"thdb34dmInPwd"}
